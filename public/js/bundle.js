...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaW0tZ29lbCIsImEiOiJjbGJvcHU3eTcwMmVzM3JzOW9zNW9ndGx4In0.Q4TcXZfLHFsdJT1cBFbpdg';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log('i am in login page ', email, password);
            _context.prev = 1;
            _context.next = 4;
